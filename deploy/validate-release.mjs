import { validatePublicAccounting } from './validate-accounting-assets.mjs';
...
const SERVER_FILES = ['start.mjs', 'app.mjs', 'api.mjs', 'mcp.mjs', 'backend.mjs', 'enrollment.mjs',
  ...
  'community.mjs', 'config-files.mjs', 'setup.mjs'];
...
async function main() {
  ...
  await validatePublicAccounting(stageReal, declared, { assert, jsonFile, digestFile });
